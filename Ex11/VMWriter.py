...
SEGMENT_ABBR_DICT = {"CONST": "constant",
                             "ARG": "argument",
                             "LOCAL": "local",
                             "STATIC": "static",
                             "THIS": "this",
...
class VMWriter:
    ...
    def __init__(self, output_stream: typing.TextIO) -> None:
        """saved a new file and prepares it for writing VM commands."""
    ...
    def write_push(self, segment: str, index: int) -> None:
        ...
        self.output_stream.write(f"push {SEGMENT_ABBR_DICT[segment]} {index}\n")
    ...
    def write_pop(self, segment: str, index: int) -> None:
        ...
        """
        self.output_stream.write(f"pop {SEGMENT_ABBR_DICT[segment]} {index}\n")
